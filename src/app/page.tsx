...
export default function Home() {
  ...
  return <>
    ...
    <header className="app-header"><span className="wordmark"><span className="brand-mark" aria-hidden="true">L /</span> Legal Document Navigator</span><span className="sample-badge"><span aria-hidden="true" />Sample workspace</span></header>
    <main className="entry-main" id="entry-content">
      <div className="entry-heading"><span className="eyebrow">A clearer reading</span><h1>Understand the agreement.<br /><span>Keep the source in view.</span></h1><p>A workspace for understanding terms, comparing versions, and finding the wording behind an explanation.</p></div>
