...
export function DocumentIntake() {
  ...
  if (result?.status === "ready") return <SourceWorkspace key={result.document.id} document={result.document} warnings={result.warnings} onClear={clear} />;
  return <section className="document-intake" aria-labelledby="intake-heading">
    ...
    <p className="intake-privacy">Processed in this browser. Document contents are not uploaded or saved by this app. Clear or reload to reset. Browser and operating-system retention are outside this app’s control.</p>
